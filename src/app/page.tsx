  ...
  return (
    <main className="flex-1">
      <section className="relative min-h-[92vh] overflow-hidden pt-[4.25rem]">
        <div className="grid-motion-bg pointer-events-none absolute inset-0 opacity-80" />
        <div
          ...
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              >
                <Link
                  href="/kontakt"
                  className="inline-flex rounded-full bg-red-600 px-8 py-3.5 text-sm font-semibold text-white shadow-md shadow-red-600/25 transition-transform hover:scale-[1.02] hover:bg-red-700"
                >
                  Zapytaj o transport
                </Link>
                <Link
            ...
            <motion.div
              ...
              className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl shadow-slate-900/10"
            >
              <Image
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-28">
        <div className="grid gap-14 lg:grid-cols-2 lg:gap-20">
          ...
          <FadeUp delay={0.08}>
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-slate-200 shadow-lg shadow-slate-900/5">
              <Image
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-28">
        <div className="grid gap-14 lg:grid-cols-2 lg:items-center">
          ...
          <FadeUp delay={0.1}>
            <div className="relative aspect-square overflow-hidden rounded-2xl border border-slate-200 shadow-lg shadow-slate-900/5 sm:aspect-[5/4]">
              <Image
